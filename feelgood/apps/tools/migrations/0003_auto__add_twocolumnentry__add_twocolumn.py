...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TwoColumnEntry'
        db.create_table('tools_twocolumnentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sheet', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entries', to=orm['tools.TwoColumn'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('column_one', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ('column_two', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
        ))
        db.send_create_signal('tools', ['TwoColumnEntry'])

        # Adding model 'TwoColumn'
        db.create_table('tools_twocolumn', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=140)),
            ('column_one_title', self.gf('django.db.models.fields.CharField')(max_length=140)),
            ('column_two_title', self.gf('django.db.models.fields.CharField')(max_length=140)),
        ))
        db.send_create_signal('tools', ['TwoColumn'])


    def backwards(self, orm):
        
        # Deleting model 'TwoColumnEntry'
        db.delete_table('tools_twocolumnentry')

        # Deleting model 'TwoColumn'
        db.delete_table('tools_twocolumn')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 22, 16, 22, 57, 940285)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 22, 16, 22, 57, 940209)'}),
        ...
        'tools.twocolumn': {
            ...
            'column_one_title': ('django.db.models.fields.CharField', [], {'max_length': '140'}),
            'column_two_title': ('django.db.models.fields.CharField', [], {'max_length': '140'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '140'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'tools.twocolumnentry': {
            'Meta': {'object_name': 'TwoColumnEntry'},
            'column_one': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'column_two': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sheet': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'entries'", 'to': "orm['tools.TwoColumn']"}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        }
    }
